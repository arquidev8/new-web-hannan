...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="relative font-[sans-serif] before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
      <img src="https://i.postimg.cc/kGyCQMNL/1.jpg" alt="Banner Image" class="absolute inset-0 w-full h-full object-cover" />
      <div class="min-h-[300px] relative z-10 h-full max-w-6xl mx-auto flex flex-col justify-center items-center text-center text-white p-6">
        <h2 class="sm:text-4xl text-2xl font-bold mb-6">¡Vende o alquila con nosotros!</h2>
        <p class="text-lg text-center text-gray-200">Rellena el formulario para obtener más información.</p>
...
<div class="p-12 justify-center mt-20 mb-20">
  ...
  <div class="grid sm:grid-cols-2 gap-6">
    ...
    <div class="relative flex items-center sm:col-span-2">
     ...
     <div class="relative flex items-center sm:col-span-2">
        <select
          class="px-4 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-red-500 outline-none">
          <option value="" disabled selected>¿Qué quieres hacer con tu propiedad?</option>
          <option value="vender">Vender</option>
          <option value="alquilar">Alquilar</option>
        </select>
        <!-- ... (código del ícono para el desplegable) ... -->
      </div>
