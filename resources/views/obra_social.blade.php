...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="relative font-[sans-serif] before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
      <img src="https://i.postimg.cc/zBLcHknD/4.jpg" alt="Banner Image" class="absolute inset-0 w-full h-full object-cover" />
      <div class="min-h-[300px] relative z-20 h-full max-w-6xl mx-auto flex flex-col justify-center items-center text-center text-white p-6">
        <h2 class="sm:text-4xl text-2xl font-bold mb-6">Obra Social</h2>
...
<div class="bg-white p-8 font-[sans-serif] mt-20 mb-20">
      <div class="max-w-6xl mx-auto grid md:grid-cols-2 justify-center items-center gap-4">
        <div class="text-center md:text-left">
          <h1 class="text-3xl font-extrabold text-black mb-6 md:!leading-[55px]">WILLIAM W. HANNAN</h1>
          <p class="text-justify text-lg lg:text-xl text-black mb-8">Tuvo una vida de notable actividad, de logros exitosos, de gran propósito y de planes cumplidos. Sin embargo, al morir decidió dejarle dos tercios de su patrimonio a organizaciones benéficas de Detroit, incluida la Children’s Aid Society.

Inspirados en su vida y con el propósito de continuar su legado, queremos aportar a las comunidades aledañas a nuestras oficinas tiempo, esfuerzo y dinero destinados a obra social.</p>
         
        </div>
        <div class="text-center">
          <img src="https://i.postimg.cc/yxG6XjGf/William-Washington-Hannan-1-1.jpg" alt="Premium Benefits" class="w-2/4 mx-auto rounded-full" />
        </div>
      </div>
    </div>


    <section class="bg-slate-400 text-white mb-20">
    <div class=" flex flex-col items-center px-5 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col w-full max-w-3xl mx-auto prose text-left prose-blue">
            <div class="w-full mx-auto text-center ">
                <h1>“El éxito acompaña a las personas cuando hacen el uso correcto de su talento, su tiempo y sus oportunidades”</h1>
                <br>
                <h2>William W. Hannan</h2>
            </div>
        </div>
    </div>
</section>
